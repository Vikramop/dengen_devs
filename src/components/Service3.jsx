...
const Service3 = () => {
  return (
    <div className="relative bg-[#0b114a] text-white flex items-center justify-between h-[70vh] px-24 ">
      <div>
        <img src={bg} alt="img" className="absolute top-40 z-50" />
        <img src={img} className="relative w-[550px] z-[100]" />
      </div>
      <div className="z-[100]">
        ...
        <h1 className="text-[64px] font-cabinetBold leading-none mb-12">
          Technical <br />
          Consultancy
        </h1>
