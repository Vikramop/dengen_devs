...
const Features = () => {
  return (
    <div className="relative text-white bg-[#0b114a] flex justify-between items-center px-24 h-[180vh] font-cabinetBold uppercase ">
      <div className="z-[100]">
        <p className="text-[64px] mb-[110px]">
        ...
        <div className="text-[20px] gap-[50px] flex flex-col mb-[110px] ">
          <p>
        ...
        <div>
          ...
          <p className="text-[16px] font-cabinetLight mb-[40px]">
      ...
      <div className="flex flex-col gap-[84px] z-[600]">
        <div className="flex gap-[24px]">
          <img src={box1} className="w-[340px] h-[615px]" />
          <img src={box2} className="w-[340px] h-[615px]" />
        </div>
        <div className="flex gap-[24px]">
          <img src={box3} className="w-[340px] h-[615px]" />
          <img src={box4} className="w-[340px] h-[615px]" />
        </div>
      </div>
